$(document).ready(function() {
  ...
  $('.title-font').click(function(event){
    $('.suggested').removeClass('display');
    $('.image-background1').addClass('hide');
    $('.image-background2').addClass('hide');
  })
  $('.miraflores').click(function(event) {
    $('.suggested').addClass('display');
    $('.image-background1').addClass('miraflores-1 border').html('<p type="button" class="btn btn-primary btn-style" data-toggle="modal" data-target="#miModal" id= "myBtn"></p>');
    ...
    $('.image-background2').addClass('miraflores-2 border').html('<p type="button" class="btn btn-primary btn-style2" data-toggle="modal" data-target="#miModal2" id= "myBtn2"></p>');
  ...
  $('.san-isidro').click(function(event) {
    $('.suggested').addClass('display');
    $('.image-background1').addClass('isidro-1 border').html('<p type="button" class="btn btn-primary btn-style " data-toggle="modal" data-target="#miModal" id= "myBtn"></p>');
    $('.btn-style').append(isidro[0]);
    $('.image-background1').removeClass('miraflores-1');
    $('.image-background2').removeClass('miraflores-2');
    $('.image-background1').removeClass('surco-1');
    $('.image-background2').removeClass('surco-2');
    $('.image-background2').addClass('isidro-2 border').html('<p type="button" class="btn btn-primary btn-style2" data-toggle="modal" data-target="#miModal2" id= "myBtn2"></p>');
  ...
  $('.surco').click(function(event) {
    $('.suggested').addClass('display');
    $('.image-background1').addClass('surco-1 border').html('<p type="button" class="btn btn-primary btn-style" data-toggle="modal" data-target="#miModal" id= "myBtn"></p>');
    $('.btn-style').append(surco[0]);
    $('.image-background1').removeClass('miraflores-1');
    $('.image-background2').removeClass('miraflores-2');
    $('.image-background1').removeClass('isidro-1');
    $('.image-background2').removeClass('isidro-2');
    $('.image-background2').addClass('surco-2 border').html('<p type="button" class="btn btn-primary btn-style2" data-toggle="modal" data-target="#miModal2" id= "myBtn2"></p>');
